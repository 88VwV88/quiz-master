...
!(function (t, e) {
    ...
    var e = t
      ? Object.keys(t)
          .map(function (e) {
            var r = t[e];
            if (void 0 === r) return "";
            if (null === r) return Lt(e);
            if (Array.isArray(r)) {
              var n = [];
              return (
                r.forEach(function (t) {
                  void 0 !== t &&
                    (null === t ? n.push(Lt(e)) : n.push(Lt(e) + "=" + Lt(t)));
                }),
                n.join("&")
              );
            }
  ...
  function a(t, e, r, n) {
    ...
    return (r && (a.redirectedFrom = s(r, o)), Object.freeze(a));
  }
  function u(t) {
  ...
  function R(t) {
    ...
    return function (r, n) {
      for (
        var o = "",
          i = r || {},
          a = (n || {}).pretty ? x : encodeURIComponent,
          u = 0;
        u < t.length;
        u++
      ) {
        ...
        if ("string" != typeof c) {
          ...
          if (Bt(p)) {
            ...
            if (((s = c.asterisk ? k(p) : a(p)), !e[u].test(s)))
              throw new TypeError(
                'Expected "' +
                  c.name +
                  '" to match "' +
  ...
  function _(t, e, r) {
    ...
    return C(new RegExp("(?:" + n.join("|") + ")", j(r)), e);
  }
  function T(t, e, r) {
    return S(w(t, r), e, r);
  }
  ...
  function $(t, e, r) {
    return (
      Bt(e) || ((r = e || r), (e = [])),
      (r = r || {}),
      t instanceof RegExp ? A(t, e) : Bt(t) ? _(t, e, r) : T(t, e, r)
    );
  }
  function q(t, e, r) {
    try {
      return (Qt[t] || (Qt[t] = Ft.compile(t)))(e || {}, { pretty: !0 });
    } catch (t) {
      return "";
    }
  }
  ...
  function H(t, e, r, o) {
    ...
    if (!i.path && i.params && e) {
      ...
      if (e.name) ((i.name = e.name), (i.params = a));
        ...
        i.path = q(u, a, "path " + e.path);
      }
      return i;
    }
    var c = g(i.path || ""),
      s = (e && e.path) || "/",
      p = c.path ? m(c.path, s, r || i.append) : s,
  ...
  function V(t, e) {
    function r(t, r, n) {
      ...
      if (a) {
        ...
        if (u)
          return (
            (o.path = q(u.path, o.params, 'named route "' + a + '"')),
            i(u, o, n)
          );
      } else if (o.path) {
        o.params = {};
        for (var l = 0; l < c.length; l++) {
          var d = c[l],
            y = s[d];
          if (z(y.regex, o.path, o.params)) return i(y, o, n);
        }
      }
      return i(null, o);
    }
    function n(t, n) {
      ...
      if (
        ("string" == typeof u && (u = { path: u }), !u || "object" != typeof u)
      )
        return i(null, n);
      var c = u,
        s = c.name,
      ...
      if (
        ...
        return r(
          { _normalized: !0, name: s, query: f, hash: h, params: l },
          void 0,
          n,
        );
      if (p) {
        ...
        return r(
          {
            _normalized: !0,
            path: q(d, l, 'redirect route with path "' + d + '"'),
            query: f,
            hash: h,
          },
          void 0,
    ...
    function o(t, e, n) {
      var o = r({
        _normalized: !0,
        path: q(n, e.params, 'aliased route with path "' + n + '"'),
      });
      if (o) {
        var a = o.matched,
          u = a[a.length - 1];
  ...
  function F() {
    (window.history.replaceState({ key: tt() }, ""),
  ...
  function X(t) {
    return {
      x: W(t.x) ? t.x : window.pageXOffset,
      y: W(t.y) ? t.y : window.pageYOffset,
    };
  }
  function Y(t) {
    return { x: W(t.x) ? t.x : 0, y: W(t.y) ? t.y : 0 };
  }
  function W(t) {
  ...
  function rt(t, e) {
    ...
    try {
      e
        ? r.replaceState({ key: Gt }, "", t)
        : ((Gt = Z()), r.pushState({ key: Gt }, "", t));
    } catch (r) {
  ...
  function it(t) {
    return function (r, n, o) {
      var i = !1,
        a = 0,
        u = null;
      (at(t, function (t, r, n, c) {
        if ("function" == typeof t && void 0 === t.cid) {
          ((i = !0), a++);
          var s,
            p = st(function (e) {
              (ct(e) && (e = e.default),
                (t.resolved = "function" == typeof e ? e : _t.extend(e)),
                (n.components[c] = e),
                --a <= 0 && o());
            }),
            f = st(function (t) {
  ...
  function Ot(t) {
    Yt ? rt(Et(t)) : (window.location.hash = t);
  }
  function Ct(t) {
    Yt ? nt(Et(t)) : window.location.replace(Et(t));
  }
  function jt(t, e) {
    return (
      t.push(e),
  ...
  var _t,
    Tt = {
      ...
      render: function (t, e) {
        ...
        ((a.registerRouteInstance = function (t, e) {
          ...
          (a.attrs = {}));
        for (var y in a.props)
          ("props" in d && y in d.props) ||
            ((a.attrs[y] = a.props[y]), delete a.props[y]);
        return u(d, a, o);
      },
    },
    St = /[!'()*]/g,
    ...
    qt = /%2C/g,
    Lt = function (t) {
      return encodeURIComponent(t).replace(St, $t).replace(qt, ",");
    },
    ...
    Vt = {
      ...
      render: function (t) {
        ...
        ((s[b] = p(n, w)), (s[g] = this.exact ? s[b] : h(n, w)));
        var x = function (t) {
            d(t) && (e.replace ? r.replace(i) : r.push(i));
          },
          k = { click: d };
  ...
  ((Ft.parse = Dt),
    ...
    (Ft.tokensToFunction = Kt),
    (Ft.tokensToRegExp = Jt));
  var Qt = Object.create(null),
    ...
    Wt =
      zt && window.performance && window.performance.now
        ...
        : Date,
    Gt = Z(),
    Zt = "function" == typeof Symbol && "symbol" == typeof Symbol.toStringTag,
    te = function (t, e) {
      ((this.router = t),
        (this.base = pt(e)),
        (this.current = Mt),
  ...
  ((te.prototype.listen = function (t) {
    ...
    (te.prototype.confirmTransition = function (r, n, o) {
      var i = this,
        a = this.current,
        u = function (r) {
          (e(r) &&
      ...
      if (p(r, a) && r.matched.length === a.matched.length)
        return (this.ensureURL(), u());
      var c = ft(this.current.matched, r.matched),
        s = c.updated,
        f = c.deactivated,
        h = c.activated,
        l = [].concat(
  ...
  var ee = (function (t) {
      ...
      return (
        ...
        (e.prototype.push = function (t, e, r) {
          ...
          this.transitionTo(
            t,
            function (t) {
              (rt(b(n.base + t.fullPath)), D(n.router, t, o, !1), e && e(t));
            },
            r,
          );
        }),
        (e.prototype.replace = function (t, e, r) {
          ...
          this.transitionTo(
            t,
            function (t) {
              (nt(b(n.base + t.fullPath)), D(n.router, t, o, !1), e && e(t));
            },
            r,
          );
        }),
    ...
    re = (function (t) {
      function e(e, r, n) {
        (t.call(this, e, r), (n && xt(this.base)) || kt());
      }
      return (
        t && (e.__proto__ = t),
        (e.prototype = Object.create(t && t.prototype)),
          ...
          (r && F(),
            window.addEventListener(
              ...
              function () {
                var e = t.current;
                kt() &&
                  t.transitionTo(Rt(), function (n) {
                    (r && D(t.router, n, e, !0), Yt || Ct(n.fullPath));
                  });
              },
            ));
        }),
        (e.prototype.push = function (t, e, r) {
          ...
          this.transitionTo(
            t,
            function (t) {
              (Ot(t.fullPath), D(n.router, t, o, !1), e && e(t));
            },
            r,
          );
        }),
        (e.prototype.replace = function (t, e, r) {
          ...
          this.transitionTo(
            t,
            function (t) {
              (Ct(t.fullPath), D(n.router, t, o, !1), e && e(t));
            },
            r,
          );
        }),
  ...
  return (
    (oe.prototype.match = function (t, e, r) {
    ...
    (oe.prototype.init = function (t) {
      ...
      if ((this.apps.push(t), !this.app)) {
        this.app = t;
        var r = this.history;
        if (r instanceof ee) r.transitionTo(r.getCurrentLocation());
    ...
    (oe.prototype.push = function (t, e, r) {
      this.history.push(t, e, r);
    }),
    (oe.prototype.replace = function (t, e, r) {
    ...
    (oe.prototype.resolve = function (t, e, r) {
    ...
    (oe.install = v),
    (oe.version = "3.0.0"),
    zt && window.Vue && window.Vue.use(oe),
    oe
  );
});
