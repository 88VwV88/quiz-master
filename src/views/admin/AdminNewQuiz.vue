        ...
        <ul class="d-flex flex-column align-items-center">
          ...
          >
            <div>
              <div class="form-floating my-2">
                <textarea
                  v-model="ques.statement"
                  :id="`question-${key}-statement`"
                  class="form-control"
                  autocomplete="off"
                />
                <label :for="`question-${key}-statement`"
                  >Question {{ key + 1 }} Statement</label
                >
              </div>

              <ul>
                <li
                  v-for="(opt, j) in ques.options"
                  :key="j"
              ...
              <div class="row mt-2">
                <label class="col align-self-center" for="answer"
                  >Answer [1-4]</label
                >
                <select
                  v-model="ques.answer"
            ...
            <button
              @click.prevent="() => removeQuestion(key)"
              class="btn btn-danger align-self-center fs-5 my-2"
            >
              -
            </button>
          </li>
          <button
            ...
            class="btn btn-primary align-self-center mt-2 fs-5"
          >
            +
          </button>
        </ul>
