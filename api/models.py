...
class User(Base):
    ...
    scores: Mapped[Set["Scores"]] = relationship(back_populates="user")
...
class Subject(Base):
    ...
    chapters: Mapped[Set["Chapter"]] = relationship(back_populates="subject")
...
class Chapter(Base):
    ...
    quizzes: Mapped[Set["Quiz"]] = relationship(back_populates="chapter")
...
class Question(Base):
    ...
    options: Mapped[Set["Option"]] = relationship()
